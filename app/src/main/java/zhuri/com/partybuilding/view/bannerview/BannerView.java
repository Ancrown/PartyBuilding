...
public class BannerView<Item> extends FrameLayout {
    ...
    public BannerView(Context context, AttributeSet attrs, int defStyle) {
        ...
        float barPaddingLeft = ta.getDimension(R.styleable.BannerView_bvBarPaddingLeft, dp2px(6));
        float barPaddingTop = ta.getDimension(R.styleable.BannerView_bvBarPaddingTop, dp2px(6));
        float barPaddingRight = ta.getDimension(R.styleable.BannerView_bvBarPaddingRight, dp2px(6));
        float barPaddingBottom = ta.getDimension(R.styleable.BannerView_bvBarPaddingBottom, dp2px(6));
        ...
        int indicatorGap = ta.getDimensionPixelSize(R.styleable.BannerView_bvIndicatorGap, dp2px(5));
        int indicatorColor = ta.getColor(R.styleable.BannerView_bvIndicatorColor, Color.parseColor("#66000000"));
        ...
        // vTitleBar.setPadding(0, 0, 0, dp2px(5));
