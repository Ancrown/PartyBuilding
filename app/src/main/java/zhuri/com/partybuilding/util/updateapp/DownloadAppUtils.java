package zhuri.com.partybuilding.util.updateapp;
...
public class DownloadAppUtils {
    ...
    public static void download(final Context context, String url, final String serverVersionName) {
        ...
        ToolUtils.showToast(context, "正在下载中...");
        ...
        final String APPTitile = AppUtils.getString(R.string.app_name) + serverVersionName + ".apk";
        String apkLocalPath = filePath + File.separator + APPTitile;

        downloadUpdateApkFilePath = apkLocalPath;

        Log.e("eeeeee文件", "APK下载路径：" + downloadUpdateApkFilePath);
        ...
        FileDownloader.getImpl().create(url)
                ...
                .setListener(new FileDownloadLargeFileListener() {
                    ...
                    protected void progress(BaseDownloadTask task, long soFarBytes, long totalBytes) {
                        send(context, (int) (soFarBytes * 100.0 / totalBytes), APPTitile);
                    }
