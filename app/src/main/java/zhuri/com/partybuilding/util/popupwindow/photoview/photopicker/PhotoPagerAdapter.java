...
import zhuri.com.partybuilding.util.popupwindow.photoview.PhotoView;
import zhuri.com.partybuilding.util.popupwindow.photoview.PhotoViewAttacher;
...
public class PhotoPagerAdapter extends PagerAdapter {
  ...
  public Object instantiateItem(ViewGroup container, int position) {
    ...
    GlideUtils.LoadImage(mContext,path,imageView);
//    final Uri uri;
